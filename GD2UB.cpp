...
void Bitmap::fromtext(int font, const char* s)
{
  ...
  GD.finish();
  if(TFT_FT81X_ENABLE==1){GD.wr16(REG_PCLK, 2);
  }else{GD.wr16(REG_PCLK, 5);}
...
#if (TFT_FT80X2843 == 1)
  #define LOW_FREQ_BOUND  58800000UL  //800x480
  //#define LOW_FREQ_BOUND  47040000UL  //480x272
  //#define LOW_FREQ_BOUND  32040000UL //320x240
#endif
//TFTLCDCyg
...
#ifdef __F429ZIT6__
cmd_text(GD.w / 2, (GD.h / 2)-29, 31, OPT_CENTER, "Error en STM32F429ZIT6");
#endif
