...
#ifndef _GD2UB_H_INCLUDED
#define _GD2UB_H_INCLUDED
...
#define SD_PIN          PA15  // PC5//PA4 // 5 Riverdi-shield   9  gameduino2
...
//*******No modificar, seccion de pruebas 
#define TFT_FT80X2843      0  //0 con TFT_FT81X_ENABLE=1, 1 con TFT_FT81X_ENABLE=0 servira para la pantalla 320x240 XD
//*******No modificar, seccion de pruebas 
