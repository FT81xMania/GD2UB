...
// ****************************************************************************
// POWER ON RESET only for screen HotMCU
// by lightcalamar
// ****************************************************************************
...
//SPI.beginTransaction(SPISettings(21000000, MSBFIRST, SPI_MODE0));  //10500000

SPI.beginTransaction(SPISettings(FreqSPI1, MSBFIRST, SPI_MODE0));  //10500000
